#pragma once
#include "DAG.h"
class IPPTS_min : public scheduler {
public:
	double duration;
	int PCM(int, int);
	//double rankPCM(int);
...
int IPPTS_min::PCM(int ni, int pk)
{
...
/*double IPPTS_min::rankPCM(int ni)
{
...
void IPPTS_min::CreatDAG()
{
//	task::rand_processor();
	DAG::DAG_generate();
}

void IPPTS_min::scheduling() {
